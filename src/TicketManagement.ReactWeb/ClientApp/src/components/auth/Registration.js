...
export class Registration extends React.Component {
    constructor(props) {
        ...
        this.state = {
            ...
            passwordConfirm: "",
            language: "English",
            timeZone: "(UTC-12:00) Линия перемены дат",
        };
    }
    ...
    async handleSubmit(e) {
        ...
        let response = await fetch(AppConfiguration.Setting().AuthRegisterUrl, {
            method: "POST",
            body: formData,
        });
        ...
        return (
            <form onSubmit={this.handleSubmit}>
                ...
                <div>
                    ...
                    <select name="Language" value={this.state.language} onChange={(e) => this.setState({ language: e.target.value })}>
                ...
                <div>
                    ...
                    <select name="TimeZone" value={this.state.timeZone} onChange={(e) => this.setState({ timeZone: e.target.value })}>
